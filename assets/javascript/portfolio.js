...
(function () {
    ...
    $(document).ready(function () {
        ...
        for (var i in links) {
            ...
            $('#marquee').append('<a href="https://solo.to/' + link.link + '" target="_BLANK">' + link.name + '</a>');
    ...
    (function () {
            ...
            writeLine(["director override granted...", "initializing tracer program... <span style='font-size: 14px; color: #ffffff;'>recalibrating decryption software</span>..."], 30, function () {
                ...
                writeLine(["local drives scan <span style='font-size: 14px; color: #00FF00;'>[success]</span>...", "<span style='font-size: 14px; color: #00FF00;'>GHOST DRIVE FOUND!"], 30, 500, function () {
                    ...
                    writeLine(["<i style='color: #990000'>LAUNCHING PROJECT LOVE</i>"], 120, 500, function () {
